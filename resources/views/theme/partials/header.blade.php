          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-center">
              ...
              <li class="nav-item @yield('categories active') submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="{{ route('theme.categories', ['id'=> $category->id]) }}">{{$category->name}}</a></li>
                  @endforeach
                </ul>
              </li>
            ...
            @else
              <li class="nav-item submenu dropdown" style="list-style: none">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="{{ route('myBlogs') }}">My Blogs</a></li>
                  <li class="nav-item">
